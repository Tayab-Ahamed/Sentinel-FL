...
| **Multi-Krum only** | 100.0% | **25.8%** | −73.1 pp |
...
- **Multi-Krum alone cuts ASR by 73 pp** — consistent with the literature. This is
...
5. Full multi-seed ablation (`python scripts/run_benchmark.py --seeds 5`)
